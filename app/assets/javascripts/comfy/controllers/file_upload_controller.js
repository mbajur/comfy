...
export default class extends Controller {
  connect() {
    this.uploader = new FileUpload(this.element, {
      url: this.element.dataset.cmsUploaderUrl,
      multipart_params: {
        [this.element.dataset.cmsUploaderTokenName]: this.element.dataset.cmsUploaderTokenValue,
        [this.element.dataset.cmsUploaderSessionName]:
          this.element.dataset.cmsUploaderSessionValue,
      },
    })
  }
